...
We work for Globalcorp in a variety of teams responsible for the services that compromise our main customer facing application. We'll use Harness IDP to:
...
1.  Next to _+ New Repository_ click the dropdown arrow and select _Import Repository_.
