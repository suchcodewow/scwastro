...
<details>
  <summary>What is a deployment</summary>A deployment is a set of instructions, usually in a YAML file like below, that
...
![science](/src/assets/img/science.png)
:::
...
![dtorders frontend](/src/assets/img/dtorders-frontend.png)
...
![dtorders frontend](/src/assets/img/dtorders_services.png)
