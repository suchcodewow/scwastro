...
![Azure Overview](/src/assets/img/azureoverview.png)
...
1. Click _Add Diagnostic Setting_.
   ![dynabankwebapp1](/src/assets/img/webappsetting.png)
...
1. Make sure the hub namespace matches below & select the shown event hub.
   ![dynabankwebapp1](/src/assets/img/appdiagnostic.png)
...
![troubleshoot](/src/assets/img/troubleshoot1.jpg)
