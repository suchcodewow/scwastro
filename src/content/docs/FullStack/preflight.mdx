...
[click for Dynatrace "workshop outcomes reference"](/src/img/rafting.jpg)
...
1. In the top right bar, confirm the region is Ohio. If not, click the region and select "US EAST (OHIO)"
   ![regionselect](/src/img/preflight1.jpg)
...
3. in the top bar, open an AWS cloud shell session by clicking the shell icon.
   ![cloudshell](/src/img/preflight2.jpg)
...
1. Click the shell icon in the top bar of the Azure portal login.
   ![cloudgoogle](/src/img/cloudazure.jpg)
...
1. In your google cloud console, start a shell from the prompt icon top right.
   ![cloudgoogle](/src/img/cloudgoogle.jpg)
