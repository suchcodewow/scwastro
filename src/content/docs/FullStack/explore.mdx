...
![services](/src/assets/img/explore3.jpg)
...
![services](/src/assets/img/explore10.jpg)
...
![services](/src/assets/img/explore4.jpg)
...
1. In Settings -> Log Monitoring -> Log sources and storage, check the box for the host to enable log integration.
   ![services](/src/assets/img/explore9.jpg)
2. Make sure to save changes!
   ![services](/src/assets/img/savelogs.jpg)
...
5. Select from log types, messages, and sources in "available attributes".
   ![services](/src/assets/img/explore5.jpg)

## F) Application View

![services](/src/assets/img/explore6.jpg)
...
3. Select "1 service" in the lower right of top box.
   ![appservice](/src/assets/img/appservice.jpg)
...
3. In Capturing -> Async web requests and SPAs, enable both options under "Generic Support".
   ![genericsupport](/src/assets/img/genericsupport.jpg)
4. Enable Session Replay from the "enablement and cost control" page (under "General Settings").
   ![sessionplay](/src/assets/img/sessionreplay.jpg)
...
6. (Optional!) Dynatrace defaults to high security settings. You can unblock all items to see everything in the replay today.
   ![services](/src/assets/img/explore8.jpg)
7. Make sure to save!
   ![save](/src/assets/img/savebottomleft.jpg)
