...
2. On inner menu, click "request attributes" under "Server-side service monitoring".
   ![edit](/src/assets/img/customize3.jpg)
...
| Preprocess parameter by extracting substring        | **after** /api/main/users/login/ |

![edit](/src/assets/img/customize4.jpg)
...
5. Click "my web application", then the "..." button, then "edit".
   ![edit](/src/assets/img/customize1.jpg)
...
![appuser](/src/assets/img/appuser.jpg)

7. Make sure to save!
   ![save](/src/assets/img/usertagsave.jpg)
...
9. Click "Analyze user sessions" in the top right.
   ![analyze](/src/assets/img/analyze.jpg)
