...
![Log 2](/src/assets/img/log_2.png)
...
Please take a moment to mark the spreadsheet _Logs - Validated Logs_ column for your row with `done`.

![Log 3](/src/assets/img/log_3.png)
...
![Log 4](/src/assets/img/log_4.png)

Click on `Create Metric`

![Log 5](/src/assets/img/log_5.png)
...
![Log 6](/src/assets/img/log_6.png)
...
![Log 7](/src/assets/img/log_7.png)
...
![Log 8](/src/assets/img/log_8.png)
...
![Log 9](/src/assets/img/log_9.png)
...
![Log 10](/src/assets/img/log_10.png)

Execute the Log Ingest POST (x3)

Navigate to `Problems` (refresh page) and look for the `Perform 2022 Log Error Event`

![Log 11](/src/assets/img/log_11.png)

### :checkered_flag: Checkpoint

Please take a moment to mark the spreadsheet _Logs - Created Metric & Alert_ column for your row with `done`.
