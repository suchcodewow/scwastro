...
Please take a moment to mark the spreadsheet _fluentd - Restructued Logs_ column for your row with `done`.
...
![fluentd_2_1](/src/assets/img/dt_fluentd_record_transformer.png)
...
Please take a moment to mark the spreadsheet _fluentd - switched to Dynatrace plugin_ column for your row with `done`.
...
![fluentd_2_2](/src/assets/img/dt_fluentd_logviewer.png)
...
![fluentd_2_3](/src/assets/img/dt_fluentd_log_detail.png)

#### Create a metric out of our logs

Create a metric exposing the label `responsetime` time ingested by dynatrace
![fluentd_2_4](/src/assets/img/dt_fluentd_log_create_metric.png)
...
Please take a moment to mark the spreadsheet _fluentd - Created Log Graph_ column for your row with `done`.
