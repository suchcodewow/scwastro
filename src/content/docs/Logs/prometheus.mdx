...
![Prometheus_4.1](/img/prom_4.1.png)
...
![prom_metrics_screen](/img/prom_metrics_screen.png)
...
![Prometheus 6](/img/prom_6.png)

Select the visualization `single value`

![Prometheus 7](/img/prom_7.png)
