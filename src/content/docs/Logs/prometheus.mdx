...
![Prometheus_1](/src/assets/img/prom_1.png)
...
![Prometheus_2](/src/assets/img/prom_2.png)
...
![Prometheus_4](/src/assets/img/prom_4.png)
...
![Prometheus_4.1](/src/assets/img/prom_4.1.png)
...
![Prometheus_3](/src/assets/img/prom_3.png)

The result should be a large output of available node exporter metrics:

![Prometheus_3.3](/src/assets/img/prom_3.3.png)

### :checkered_flag: Checkpoint

Please take a moment to mark the spreadsheet _Prometheus - Test Metric Endpoint_ column for your row with `done`.
...
Please take a moment to mark the spreadsheet _Prometheus - Setup 3 Exporters_ column for your row with `done`.
...
![prom_metrics_screen](/src/assets/img/prom_metrics_screen.png)
...
![Prometheus 5](/src/assets/img/prom_5.png)
...
![Prometheus 6](/src/assets/img/prom_6.png)

Select the visualization `single value`

![Prometheus 7](/src/assets/img/prom_7.png)

### :checkered_flag: Checkpoint

Please take a moment to mark the spreadsheet _Prometheus - Setup Data Explorer_ column for your row with `done`.
...
![Prometheus 8](/src/assets/img/prom_8.png)
