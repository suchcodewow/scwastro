...
![metric 1](/src/img/metric_1.png)

-Set token name `Perform 2022`

![metric 1_1](/src/img/metric_1_1.png)

- Search for `metric`
- Select `Ingest Metrics` & `Read Metrics` & `Write Metrics` API v2

![metric 2](/src/img/metric_2.png)

- Search for `logs`
- Select ` Ingest Logs` & `Read Logs` API v2

![metric 3](/src/img/metric_3.png)
...
![metric 4.7](/src/img/metric_4.7.png)
...
![metric 12](/src/img/metric_12.png)
