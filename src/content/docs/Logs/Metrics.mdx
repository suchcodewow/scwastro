...
![metric 1](/src/assets/img/metric_1.png)

-Set token name `Perform 2022`

![metric 1_1](/src/assets/img/metric_1_1.png)

- Search for `metric`
- Select `Ingest Metrics` & `Read Metrics` & `Write Metrics` API v2

![metric 2](/src/assets/img/metric_2.png)

- Search for `logs`
- Select ` Ingest Logs` & `Read Logs` API v2

![metric 3](/src/assets/img/metric_3.png)
...
Please take a moment to mark the spreadsheet _Metrics - Created Tokens_ column for your row with `done`.

### Send data to Dynatrace

![metric 4](/src/assets/img/metric_4.png)

- POST Metric via API
- Navigate to `Environment API v2` via Account Icon

![metric 4.4](/src/assets/img/metric_4.4.png)

- Search for `Metrics` then select `POST` /metrics/ingest

![metric 4.5](/src/assets/img/metric_4.5.png)

- Copy and Paste API-TOKEN via lock icon and authorize token

![metric 4.6](/src/assets/img/metric_4.6.png)
...
![metric 4.7](/src/assets/img/metric_4.7.png)
...
![metric 5](/src/assets/img/metric_5.png)

- It may take a minute, refresh screen if metric doesn't appear

### :checkered_flag: Checkpoint

Please take a moment to mark the spreadsheet _Metrics - Called API_ column for your row with `done`.
...
![metric 6](/src/assets/img/metric_6.png)
...
![metric 7](/src/assets/img/metric_7.png)
...
![metric 8](/src/assets/img/metric_8.png)

### Review Dashboard

Open `Perform 2022 Dashboard` and review `Perform 2022 Metric` tile

![metric 9](/src/assets/img/metric_9.png)
...
![metric 12](/src/assets/img/metric_12.png)
...
![metric 13](/src/assets/img/metric_13.png)

> 4. Click on the problem to open the problem card
> 5. Identify the dynamic `Country` and `Sate` value

![metric 14](/src/assets/img/metric_14.png)

### :checkered_flag: Checkpoint

Please take a moment to mark the spreadsheet _Metrics - Created Dashboard & Alerts_ column for your row with `done`.
