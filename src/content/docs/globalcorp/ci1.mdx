...
1. Follow the table to configure:
   | Field | Value |
   | ----- | ----------------------- |
   | Name | `Globalcorp Servicenow` |
   |![Project Select](/images/continue.png)||
   |ServiceNow URL| `https://ven03172.service-now.com`|
   | username| `demo-admin`|
   |Password/API Key|click _Create or Select a Secret_|
...
1. Name it `Fastlane-Java`, then click _Start_.
